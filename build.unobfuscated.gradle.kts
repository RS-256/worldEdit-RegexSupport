...
dependencies {
    ...
    implementation("com.sk89q.worldedit:worldedit-fabric-mc${sc.current.version}:${property("deps.worldedit")}")
}
...
val accesswidener = when {
    sc.current.parsed >= "26.1" -> "wers.unobfuscated.accesswidener"
    else                        -> "wers.obfuscated.accesswidener"
}
